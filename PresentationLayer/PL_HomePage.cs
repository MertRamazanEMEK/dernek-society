...
namespace PresentationLayer
{
    public partial class PL_HomePage : Form
    {
        ...
        private void şehirlereGöreÜyeSayısıToolStripMenuItem_Click(object sender, EventArgs e)
        {
            PL_ZedGraphCity PL_ZedGraphCity = new PL_ZedGraphCity();
            PL_ZedGraphCity.StartPosition = FormStartPosition.CenterScreen;
            PL_ZedGraphCity.Show();
        }

        private void aylaraGöreÜcretGrafiğiToolStripMenuItem_Click(object sender, EventArgs e)
        {
            PL_ZedGraphAidat PL_ZedGraphAidat = new PL_ZedGraphAidat();
            PL_ZedGraphAidat.StartPosition = FormStartPosition.CenterScreen;
            PL_ZedGraphAidat.Show();
        }
    }
    }
